package com.example.yogavignesh.mygame;
...
{
    public static final int WIDTH = 2247;
    ...
    public void surfaceCreated(SurfaceHolder holder){
        ...
        player = new Player(BitmapFactory.decodeResource(getResources(), R.drawable.helicopter), 227, 90, 3);
...

    {
        if(player.getPlaying()) {
            ...
            if(missileElapsed >(2000 - player.getScore()/4)){
                ...
                if(missiles.size()==0)
                {
                    missiles.add(new Missile(BitmapFactory.decodeResource(getResources(),R.drawable.
                            missile),WIDTH + 15, HEIGHT/2, 150, 47, player.getScore(), 13));
                }
                else
                {

                    missiles.add(new Missile(BitmapFactory.decodeResource(getResources(),R.drawable.missile),
                            WIDTH+15, (int)(rand.nextDouble()*(HEIGHT - (maxBorderHeight * 2))+maxBorderHeight),150,47, player.getScore(),13));
                }
            ...
            if(!reset)
            {
                ...
                reset = true;
                dissapear = true;
                explosion = new Explosion(BitmapFactory.decodeResource(getResources(),R.drawable.explosion),player.getX()-60,
                        player.getY()-100, 350, 350, 25);
            }
    ...
    public void drawText(Canvas canvas)
    {
        ...
        if(!player.getPlaying()&&newGameCreated&&reset)
        {
            ...
            canvas.drawText("PRESS AND HOLD TO GO UP", WIDTH/2-100, HEIGHT/2 + 80, paint1);
            canvas.drawText("RELEASE TO GO DOWN", WIDTH/2-100, HEIGHT/2 + 120, paint1);
        }
    }
